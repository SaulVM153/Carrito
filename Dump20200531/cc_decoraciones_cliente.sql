...
CREATE TABLE `cliente` (
  ...
  UNIQUE KEY `UserCliente_UNIQUE` (`UserCliente`),
  UNIQUE KEY `PasswordCliente_UNIQUE` (`PasswordCliente`)
...
INSERT INTO `cliente` VALUES (1,'Andres','Martinez','AndresM','987654','1995-03-03','5526487419');
...
-- Dump completed on 2020-05-31 23:58:28
